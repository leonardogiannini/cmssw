...
process.pfDeepFlavourTagInfos = cms.EDProducer("DeepFlavourTagInfoProducer",
    ...
    packed_PFCandidates = cms.InputTag("packedPFCandidates"),
...
process.updatedPatJetsTransientCorrected = cms.EDProducer("PATJetUpdater",
    ...
    printWarning = cms.bool(True),
    tagInfoSources = cms.VInputTag(cms.InputTag("pfDeepFlavourTagInfos"), cms.InputTag("pfDeepCSVTagInfos"), cms.InputTag("pfImpactParameterTagInfos"), cms.InputTag("pfInclusiveSecondaryVertexFinderTagInfos"), cms.InputTag("pfSecondaryVertexTagInfos")),
    userData = cms.PSet(
        userCands = cms.PSet(
            src = cms.VInputTag("")
        ),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('101X_mcRun2_asymptotic_v2'),
