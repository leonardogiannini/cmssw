...
modifyConfigurationForTrackingMkFitFithltInitialStepMkFitConfig_ = hltTrackingMkFitFitInitialStep.makeProcessModifier(_addProcesshltInitialStepMkFitConfig)
