...
std::unique_ptr<mkfit::IterationConfig> MkFitIterationConfigESProducer::produce(
  ...
  it_conf->m_backward_params.validHitBonus = validHitBonus_;
  it_conf->m_params.validHitSlope = validHitSlope_;
  it_conf->m_backward_params.validHitSlope = validHitSlope_;
  it_conf->m_params.overlapHitBonus = overlapHitBonus_;
  it_conf->m_backward_params.overlapHitBonus = overlapHitBonus_;
  it_conf->m_params.missingHitPenalty = missingHitPenalty_;
  it_conf->m_backward_params.missingHitPenalty = missingHitPenalty_;
  it_conf->m_params.tailMissingHitPenalty = tailMissingHitPenalty_;
  it_conf->m_backward_params.tailMissingHitPenalty = tailMissingHitPenalty_;
