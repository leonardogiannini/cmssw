...
namespace mkfit {
  ...
  public:
    ...
    void importSeed(const Track& seed,  int seed_idx, const IterationParams& params, const track_score_func& score_func, int region);
  ...
  public:
    ...
    void insertSeed(const Track& seed, int seed_idx, const IterationParams& params, const track_score_func& score_func, int region, int pos) {
      assert(pos < m_size);
